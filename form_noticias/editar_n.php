    ...
    <div class="form">
    <h2 class = "title">Editar noticia</h2>
        <form action="#" method="POST" name="form_news">
            <h5>Título</h5><input type="text" name="titulo" value="" class="input_form"><br><br>
            <h5>Contenido</h5><input type="text" name="contenido" value="" placeholder="Escriba el contenido aqui..." size="200" class="input_form"><br><br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    ...
                    editarNoticias('titulo', 'contenido', 'autor', 'hora', 'likes');
